...
//                     console.log("Error loading model. Trying again in 2 seconds...")
//                     window.setTimeout(campusLoader.load, 2000);
//                     return;
//                 }
...
//                 console.log( 'Error while loading satellite view: ' + error );
...
//         } catch (e) {
//             if (x.matches) {
//                 error.innerHTML = "Satellite view is still loading... <br/> try again in 15 seconds. <br/> <span style= \"font-size: 0.7rem; \">This may not work on mobile devices.<span/>"
//             } else {
//                 error.innerHTML = "Satellite view is still loading... <br/> try again in 15 seconds."
//             }
...
function activateMatterport (){
    ...
    matterportFrame.className = "webgl"
